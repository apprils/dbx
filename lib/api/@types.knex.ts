...
declare module "knex" {
  namespace Knex {
    interface QueryBuilder<TRecord, TResult> {
      ...
      selectRaw(raw: string): import("knex").Knex.QueryBuilder<TRecord, TResult>;

      onConflictRaw(columns: string): import("knex").Knex.OnConflictQueryBuilder<TRecord, TResult>;
      onConflictRaw(columns: string[]): import("knex").Knex.OnConflictQueryBuilder<TRecord, TResult>;
      ...
      minValue<TResult = any>(column: string | import("knex").Knex.Raw): Promise<TResult | undefined>;
      maxValue<TResult = any>(column: string | import("knex").Knex.Raw): Promise<TResult | undefined>;
